...
class LFQ(Module):
    ...
    def forward(
        ...
        with quantization_context():
            ...
            # entropy aux loss - only compute if entropy_loss_weight > 0
            ...
            if self.training and self.entropy_loss_weight > 0:
                ...
                # if not training or entropy_loss_weight is 0, just return dummy 0
                entropy_aux_loss = per_sample_entropy = codebook_entropy = self.zero

            # whether to make the entropy loss positive or not through a (shifted) softplus

            if self.training and self.experimental_softplus_entropy_loss and self.entropy_loss_weight > 0:
